					...
					<sf:form class="form-horizontal" id="billingForm" method="POST" modelAttribute="billing">
						...
						<div class="form-group">
							...
							<!-- Submit Button to move to the personal -->
								<button type="submit" class="btn btn-primary btn-md" name="_eventId_personal"><span class="fa fa-angle-left"></span> Previous-Personal </button>
							<!-- Submit Button to move to the confirm -->
								<button type="submit" class="btn btn-primary btn-md" name="_eventId_confirm">Next-Confirm <span class="fa fa-angle-right"></span> </button>	
							</div>
						</div>
